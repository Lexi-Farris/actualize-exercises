...
if 2 > 3          #6 conditon will never happen, skip section
  x = 10          
  if 2 == 2       
    y = 20        
    if 3 == 3     
  ...
  w = 9           
elsif 2 == 2    #7 this is true  
  x = 70        #8 (v is 1, w is 2, x is 70, y is 4, z is 5)  
  if 2 > 1      #9 yes, this will execute   
    y = 80      #10 (v is 1, w is 2, x is 70, y is 80, z is 5)   
  else          #11 this will NOT run since line 22 is true 
    z = 90        
  end             
  if x < 100   #12 New statement. 70 is less than 100
    w = 8      #13 (v is 1, w is 8, x is 70, y is 80, z is 5)   
    if z == 30 #14 z is 5. this will NOT run   
      y = 100     
    else       #15 this WILL run   
      y = 14   #16  (v is 1, w is 8, x is 70, y is 14, z is 5)     
      if w > 10 #17 w=8 will NOT run   
        v = 1000  
      end         
    end           
  else        #18 will NOT run since line 27 is TRUE     
    w = 19        
    if z == 200   
      y = 87      
    else          
...
# final values from line 32: (v is 1, w is 8, x is 70, y is 14, z is 5)  
